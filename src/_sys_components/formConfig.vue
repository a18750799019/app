  ...
  <div class="__sysFrom">
    ...
    <div class="formTable" :style="formStyle">
        <el-table
          ...
          :data="perPageDatas" height="100%"  style="width: 100%;">
            <el-table-column v-if="isCheckbox" type="selection" width="55"></el-table-column>
            <el-table-column  align="center" v-if="isIndex" type="index" label="序号" idth="50">
...
export default {
  ...
  methods:{
    ...
    handleSizeChange(num){
      this.currentPage = 1;
      this.pageSize=num;
      this.perPageDatas = this.tableData.slice(num* (this.currentPage-1), num* this.currentPage)
    },
    handleCurrentChange(num){
      this.currentPage = num;
      this.perPageDatas = this.tableData.slice((num-1)* this.pageSize, num*this.pageSize)
    }
  }
}
</script>
